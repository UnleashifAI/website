...
const teamMembers = [
  {
    ...
    bio: "Ph.D. in AI and Computer Vision Systems. Former Vice President with 15+ years of executive leadership in AI R&D commercialization and global technology strategy. Specialized in regulatory compliance, risk mitigation, and strategic AI implementation for professional practices.",
  ...
  },
  {
    ...
    role: 'Strategic Implementation Team',
    bio: 'Our network of specialized partners brings deep expertise in industry-specific compliance, technical implementation, and project management. We maintain strict confidentiality while delivering exceptional results for professional practices.',
    email: 'info@unleashifai.com',
    linkedin: ' ',
    twitter: ' ',
  },
  {
    ...
    bio: 'Our technical team combines advanced AI capabilities with regulatory expertise across healthcare (HIPAA), building automation, and professional services. We ensure every solution meets the highest standards of security and compliance.',
    email: 'info@unleashifai.com',
    linkedin: ' ',
    twitter: ' ',
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Executive-level AI expertise combined with deep regulatory knowledge and specialized
            compliance experience to deliver strategic solutions for professional practices.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              <div className={`bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-md transition-all duration-300 ${activeProfile === index
              ...
              {/* Card decoration */}
              <div className={`absolute inset-0 bg-purple-600/10 rounded-2xl transform translate-x-2 translate-y-2 -z-10 transition-transform duration-300 ${activeProfile === index ? 'translate-x-4 translate-y-4' : ''
                }`}></div>
            </div>
          ))}
        </div>
